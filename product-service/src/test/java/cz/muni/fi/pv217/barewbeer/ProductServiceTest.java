...
public class ProductServiceTest {
    ...
    public void testCreateProduct() {
        given()
            .body("{\"name\": \"Test product\", \"description\": \"This is description\", \"price\": 12345, \"categories\": [\"PILSNER\", \"WITBIER\"]}")
    ...
    public void testGetProducts() {
        ...
        .then()
            ...
            .body("price", containsInAnyOrder(12345, 0, 1));
    }
